...
- **Le twist** : **les obus rebondissent** sur les murs, une fois par défaut (2 ou 4 au choix de l'hôte). Une simple **flèche** montre la direction du canon, sans aucun aperçu du rebond : viser un mur reste un calcul de tête, pas une lecture de ligne. Les obus traversent les coéquipiers, mais **ton propre obus peut te revenir dessus** une fois qu'il a rebondi.
